...
#define CALLSIGN "GAF-11"     // enter your callsign here - less then 6 letter callsigns please add "spaces" so total length is 6 (without SSID)
#define WX_CALLSIGN "GAFw-11"  // use same callsign but you can use different SSID
#define LONGITUDE_PRESET "08407.85W" // 09356.70N, 08407.85Wplease in APRS notation DDDMM.mmE or DDDMM.mmW
#define LATIDUDE_PRESET "09356.70N"   // please in APRS notation DDMM.mmN or DDMM.mmS
#define APRS_SYMBOL "_"         // other symbols are
                                // "_" => Weather Station
                                // ">" => CAR
                                // "[" => RUNNER
                                // "b" => BICYCLE
...
//#define HC_SR05_TRIGGER_PIN 32
//#define HC_SR05_ECHO_PIN 33
//#define MAX_DISTANCE_HC_SR05 200

#define TRIGGER_PIN 32  // Pin Trigger
#define ECHO_PIN 33     // Pin Echo
#define NUM_MEASUREMENTS 10
#define MAX_DISTANCE 500 // Máxima distancia válida en cm


extern float distance; // Declaración externa

// Declaraciones globales
float distanceSum = 0;  // Suma de distancias
